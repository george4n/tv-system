...
# ----------
webhook_url="https://hooks.slack.com/services/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"       # Incoming Webhooks integration URL
upload_token=""      # The user's API authentication token, only used for file uploads
channel="log"    # Default channel to post messages. '#' is prepended, if it doesn't start with '#' or '@'.
tmp_dir="/tmp"       # Temporary file is created in this directory.
username="kundservice"  # Default username to post messages.

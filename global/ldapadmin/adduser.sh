...
echo "Group Number: 501=foretag, 502=telesales=, 503=kundservice, 504=televinken"
read GROUPNUMBER
...
GROUPNAME="foretag"
NFS_DIR="/media/rdata/home/users/foretag"
SKEL_DIR="/media/rdata/home/users/foretag/sforetag"

elif [ $GROUPNUMBER = "502" ]; then
HOME_DIR="$BASE_DIR/telesales/$USERNAME"
GROUPNAME="telesales"
NFS_DIR="/media/rdata/home/users/telesales"
SKEL_DIR="/media/rdata/home/users/telesales/stelesales"

elif [ $GROUPNUMBER = "503" ]; then
HOME_DIR="$BASE_DIR/kundservice/$USERNAME"
GROUPNAME="kunservice"
NFS_DIR="/media/rdata/home/users/kundservice"
SKEL_DIR="/media/rdata/home/users/kundservice/skundservice"

elif [ $GROUPNUMBER = "504" ]; then
HOME_DIR="$BASE_DIR/televinken/$USERNAME"
GROUPNAME="people"
NFS_DIR="/media/rdata/home/users/televinken"
SKEL_DIR="/media/rdata/home/users/televinken/Skel-Televinken"
...
ssh neo@172.20.100.11 "SKEL_DIR=$SKEL_DIR;
...
sleep 1;
sudo cp -r $SKEL_DIR/.purple/ $NFS_DIR/$USERNAME/;
echo "Pidgin config complete!";
sleep 1;
sudo chown -R "$NEWUID:$GROUPNUMBER" $NFS_DIR/$USERNAME/;
echo "CHOWN Complete";

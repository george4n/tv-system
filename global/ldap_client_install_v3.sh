...
function configure_sources {
	...
	rm $SOURCES
	echo '
deb ftp://skynet.tvloc/ubuntu/ trusty main restricted universe multiverse
deb ftp://skynet.tvloc/ubuntu/ trusty-security main restricted universe multiverse
deb ftp://skynet.tvloc/ubuntu/ trusty-updates main restricted universe multiverse
deb ftp://skynet.tvloc/ubuntu/ trusty-backports main restricted universe multiverse
deb ftp://skynet.tvloc/ubuntu/ trusty-proposed main restricted universe multiverse
' >> $SOURCES
	echo "==========================================================="
